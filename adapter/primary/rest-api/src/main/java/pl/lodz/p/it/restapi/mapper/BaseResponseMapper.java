...
/**
 * Interface responsible for delivering base mapping request methods between dtos and domain models.
 *
 ...
 */
public interface BaseResponseMapper<T, U extends BaseModel> {
